...
#  see raw data includes a tally of sunspot mean values from 01/31/1749 to 08/31/2017,
# with each *id* value corresponding to a value for that month and year. Now we will attempt to extract yearly 
# trends to build models that effectively describe trends over Earth's natural orbital period.  
...
df.iloc[:,2:].plot(linestyle = '-', marker = '', color='b')
#
# There appears to be a cyclic feature to the mean count from the graph, 
# but it would be even more useful to describe that feature with a formula. 
# Initial Scrape
# Farm out columns 
